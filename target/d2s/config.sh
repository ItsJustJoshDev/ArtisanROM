...
TARGET_COMMON_SUPPORT_EMBEDDED_SIM=false # N975F/DS uses a physical dual-SIM tray, not eSIM
...
TARGET_RIL_SIM_CONFIG_MULTISIM_TRAYCOUNT="2" # N975F/DS dual-SIM tray (TPA CSC)
TARGET_RIL_SUPPORT_WATERPROOF_SIM_TRAY_MSG=true # Note10+ DS tray remains IP68-rated
